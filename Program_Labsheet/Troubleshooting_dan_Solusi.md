...
| Tegangan pada pin 3.3V/VCC bernilai sama dengan input baterai/adaptor (misal 9V), board ESP32 menjadi sangat panas (overheat), atau mati total/terbakar. | Chip regulator AMS1117 pada board ESP32 jebol (*short-circuit* internal antara pin IN dan OUT) akibat kelebihan beban arus (*overcurrent*) karena menyuplai motor servo secara langsung tanpa driver/regulator eksternal. | **Segera cabut catu daya 9V!** Ganti board ESP32 yang rusak (atau ganti chip AMS1117 SOT-223 jika memiliki keahlian solder uap). Ke depannya, gunakan regulator step-down terpisah (seperti LM2596 atau modul MB102) khusus untuk menyuplai servo 5V, dan gabungkan pin Ground (*common ground*). |
